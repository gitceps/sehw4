...
CREATE TABLE `group` (
  ...
  `groupCreatorID` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`groupID`)
...
INSERT INTO `group` VALUES (1,'홍익대',NULL),(2,'컴공과',NULL),(3,'할룽',NULL),(4,'hohoho','cjs'),(5,'kikiki','pinepale'),(6,'popgroup','pop'),(7,'powergroup','power'),(8,'hahahahaha','hahaman'),(9,'iiii','oooo');
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2016-08-08 07:51:07',NULL),('diagnostics.include_raw','OFF','2016-08-08 07:51:07',NULL),('ps_thread_trx_info.max_length','65535','2016-08-08 07:51:07',NULL),('statement_performance_analyzer.limit','100','2016-08-08 07:51:07',NULL),('statement_performance_analyzer.view',NULL,'2016-08-08 07:51:07',NULL),('statement_truncate_len','64','2016-08-08 07:51:07',NULL);
...
CREATE TABLE `user` (
  ...
  `idCardNumber` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `userRealName` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_groupID` varchar(45) DEFAULT NULL,
...
INSERT INTO `user` VALUES ('banana','1111','kdjflsjfdk','djfsj','239012','hopang',NULL),('cafe','333','lskdfnlsdkfn','dkjlskd@nadnfl.com','2839182','namu','cafe'),('cjs','1234',NULL,NULL,NULL,NULL,'kikiki'),('hahaman','1111','haha','hsh','haha','haha','cafe'),('hollys','1111','kelk','jdfljfdl','123912903','holly',NULL),('oooo','1111','kdkdkdk','kkdkdk','nfnfn','kafsn','iiii'),('pinepale','1111','d','sdflk','sdlfj','hdfo','cafe'),('pop','1111','eee','jdk','fjk','jsdlkf','popgroup'),('power','1234','address','email','kim','sung','cafe');
...
CREATE TABLE `vote` (
  ...
  `voteCreatorID` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `startTime` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `title` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `optionNum` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `vote` VALUES (357,5,'cjs','1000','hhahahahahahah',2,'2000'),(383,5,'cjs','1000','gotohome',3,'2000');
...
CREATE TABLE `voteItem` (
  ...
  PRIMARY KEY (`voteitemID`,`voteID`),
  KEY `voteID_idx` (`voteID`),
  CONSTRAINT `voteID` FOREIGN KEY (`voteID`) REFERENCES `vote` (`voteID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `voteItem` VALUES (1,383,'go',0),(2,383,'to',0),(3,383,'home',0),(4,357,'YES',0),(5,357,'NO',1);
...
-- Dump completed on 2017-06-21 12:10:41
